...
public:
  ...
  INLINE double getSample(AcidNote &outNote, bool &onNew16th);
...
INLINE double
Open303::getSample(AcidNote &outNote, bool &onNew16th)
{
  onNew16th = false;
  ...
  if (sequencer.getSequencerMode() != AcidSequencer::MIDI_PLAY && !sequencer.isRunning())
  {
    return 0.0;
  }
      ...
      sequencer.getSequencerMode() != AcidSequencer::MIDI_PLAY)
  {
    ...
    {
      noteOffCountDown = 0;
    }  // Rescue when something went wrong
